...
class BitmapGraphics 
{
	...
	public static inline function drawCircle( canvas:BitmapData, x0:Int, y0:Int, radius:Int, color:UInt=0):Void
	{
	...
	public static inline function drawArc( canvas:BitmapData, x0: Int, y0: Int, radius: Int, r1:Float, r2:Float, color:UInt=0):Void
	{
